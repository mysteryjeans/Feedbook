...
namespace HTMLConverter
{
    ...
    public static class HtmlToXamlConverter
    {
        ...
        private static void AddBreak(XmlElement xamlParentElement, XmlElement htmlElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)//(XmlElement xamlParentElement, XmlElement htmlElement, string htmlElementName)
        {
            ...
            if (htmlElement.Name == "hr")
            {
                ...
                //XmlElement xamlFigure = xamlParentElement.OwnerDocument.CreateElement(null, "Figure", _xamlNamespace);
                //XmlElement xamlUIBlock = xamlFigure.OwnerDocument.CreateElement(null, "BlockUIContainer", _xamlNamespace);

                XmlElement xamlHorizontalLine = xamlParentElement.OwnerDocument.CreateElement(null, "InlineUIContainer", _xamlNamespace);
                XmlElement xamlBorder = xamlParentElement.OwnerDocument.CreateElement(null, "Border", _xamlNamespace);
                ApplyLocalProperties(xamlBorder, localProperties, /*isBlock:*/false);

                if (localProperties != null)
                {
                    foreach (string property in localProperties.Keys)
                    {
                        string value = localProperties[property] as string;
                        ...
                        {
                            case "height":
                                xamlBorder.SetAttribute("Height", value.Replace("%", ""));
                                break;
                            case "width":
                                xamlBorder.SetAttribute("Width", value.Replace("%", ""));
                                break;
                        }
                    }
                }
                ...
                xamlHorizontalLine.AppendChild(xamlBorder);
        ...
        private static void AddInline(XmlElement xamlParentElement, XmlNode htmlNode, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            else if (htmlNode is XmlElement)
            {
                ...
                switch (htmlElementName)
                {
                    ...
                    case "br":
                    case "hr":
                        AddBreak(xamlParentElement, htmlElement, inheritedProperties, stylesheet, sourceContext);
                        break;
                    default:
        ...
        private static void AddImage(XmlElement xamlParentElement, XmlElement htmlElement, Hashtable inheritedProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            {
                switch (xamlParentElement.Name)
                {
                    case "Section":
                    case "TableCell":
                    case "FlowDocument":     
                        XmlElement xamlBlockUIContainer = xamlParentElement.OwnerDocument.CreateElement(/*prefix:*/null, "BlockUIContainer", _xamlNamespace);
                        xamlParentElement.AppendChild(xamlBlockUIContainer);
                        xamlParentElement = xamlBlockUIContainer;
                        break;
                }

                XmlElement xamlTextBlock = xamlParentElement.OwnerDocument.CreateElement(/*prefix:*/null, "TextBlock", _xamlNamespace);
                xamlParentElement.AppendChild(xamlTextBlock);
                xamlParentElement = xamlTextBlock;

                XmlElement xamlHyperlink = xamlParentElement.OwnerDocument.CreateElement(/*prefix:*/null, HtmlToXamlConverter.Xaml_Hyperlink, _xamlNamespace);
                xamlHyperlink.SetAttribute(HtmlToXamlConverter.Xaml_Hyperlink_TextDecorations, "None");
                xamlHyperlink.SetAttribute(HtmlToXamlConverter.Xaml_Hyperlink_NavigateUri, src);
                xamlParentElement.AppendChild(xamlHyperlink);
                xamlParentElement = xamlHyperlink;      
                ...
                //string[] hrefParts = src.Split(new char[] { '#' });
                //if (hrefParts.Length > 0 && hrefParts[0].Trim().Length > 0)
                //{
                //    xamlElement.SetAttribute(HtmlToXamlConverter.Xaml_Hyperlink_NavigateUri, hrefParts[0].Trim());
                //}
                ...
                //    xamlElement.SetAttribute(HtmlToXamlConverter.Xaml_Hyperlink_TargetName, hrefParts[1].Trim());
                //}
                xamlElement.SetAttribute(HtmlToXamlConverter.Xaml_Image_Source, src);
                string width = GetAttribute(htmlElement, "width");
                if (width != null)
                    xamlElement.SetAttribute(HtmlToXamlConverter.Xaml_Image_Width, width);

                string height = GetAttribute(htmlElement, "height");
                if (height != null)
                    xamlElement.SetAttribute(HtmlToXamlConverter.Xaml_Image_Height, height);
                ...
                //xamlParentElement.AppendChild(xamlFigure);
                //xamlFigure.AppendChild(xamlUIBlock);
                //xamlUIBlock.AppendChild(xamlElement);
            }
        }
            ...
            while (propertyEnumerator.MoveNext())
            {
                switch ((string)propertyEnumerator.Key)
                {
                    ...
                    case "text-decoration-none":
                        ...
                        {
                            if ((string)propertyEnumerator.Value == "true")
                                xamlElement.SetAttribute(Xaml_TextDecorations, Xaml_TextDecorations_None);
                        }
                        break;
        ...
        public const string Xaml_Hyperlink_TextDecorations = "TextDecorations";

        public const string Xaml_Section = "Section";

        public const string Xaml_Image = "Image";
        public const string Xaml_Image_Source = "Source";
        public const string Xaml_Image_Width = "Width";
        public const string Xaml_Image_Height = "Height";
        ...
        public const string Xaml_FontSize_XXLarge = "17pt"; // "XXLarge";
        public const string Xaml_FontSize_XLarge = "16pt"; // "XLarge";
        public const string Xaml_FontSize_Large = "15pt"; // "Large";
        public const string Xaml_FontSize_Medium = "14pt"; // "Medium";
        public const string Xaml_FontSize_Small = "13pt"; // "Small";
        public const string Xaml_FontSize_XSmall = "12pt"; // "XSmall";
        public const string Xaml_FontSize_XXSmall = "11pt"; // "XXSmall";
        ...
        public const string Xaml_TextDecorations_None = "None";
