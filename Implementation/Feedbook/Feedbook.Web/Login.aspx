<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="Feedbook.Web.Login" %>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Label ID="lbMessage" runat="server" EnableViewState="false" Visible="false" CssClass="messageNotification"/>
        ...
        <LayoutTemplate>
            ...
            <div>
                <fieldset class="accountInfo">
                    ...
                    <p>
                        <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">User Name Or Email:</asp:Label>
                ...
                <p class="submitButton" style="width: 375px;">
